...
public class SignupPage_Customer extends javax.swing.JFrame {
        ...
        try
				{
					...
					else
					{
                                                if(jPasswordField1.getText().equals(jPasswordField2.getText()))
						{
							...
							ps = con.prepareStatement("insert into customer values ('"+jTextField3.getText()+"','"+jPasswordField1.getText()+"','"+jTextField4.getText()+"','"+jTextField2.getText()+"','"+jTextField1.getText()+"','"+jTextField5.getText()+"','"+jTextField6.getText()+"','"+jTextField8.getText()+"','"+jTextField9.getText()+"','"+jTextField7.getText()+"')");
                                                        ps.executeUpdate(); 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            String AdminQuery="Select * from customer where username='"+jTextField3.getText()+"'";
