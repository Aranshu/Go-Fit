 ...
 * @author arans
 */
public class LoginPage_ForgotPassword_ChangePassword_Trainer extends javax.swing.JFrame {
	...
	ResultSet rs;
    public LoginPage_ForgotPassword_ChangePassword_Trainer() {
        initComponents();
    }
         ...
         try
				{
					...
					{
                                                ps = con.prepareStatement("update trainer set password ='"+jPasswordField2.getText()+"' where  username='"+LoginPage_ForgotPassword_Trainer.s+"'");
                                                ps.executeUpdate(); 
 ...
 if(evt.getKeyCode()==KeyEvent.VK_ENTER)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginPage_ForgotPassword_ChangePassword_Trainer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
