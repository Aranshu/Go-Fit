 ...
 * @author arans
 */
public class LoginPage_ChangePassword_Admin extends javax.swing.JFrame {
	...
	ResultSet rs;
    public LoginPage_ChangePassword_Admin() {
        initComponents();
    }
        ...
        try
				{
					...
					{
                                                ps = con.prepareStatement("update Admin set password ='"+jPasswordField2.getText()+"' where  username='"+LoginPage_Admin.s+"'");
                                                ps.executeUpdate(); 
 ...
 if(evt.getKeyCode()==KeyEvent.VK_BACK_SPACE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginPage_ChangePassword_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
