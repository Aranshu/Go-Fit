 ...
 * @author arans
 */
public class LoginPage_ForgotPassword_Customer extends javax.swing.JFrame {
	...
	ResultSet rs;
    public LoginPage_ForgotPassword_Customer() {
        initComponents();
    }
        ...
        try
				{
					...
					ps = con.prepareStatement("");
                                        String AdminQuery="Select * from customer where first_name='"+jTextField1.getText()+"' and username='"+jTextField4.getText()+"' and aadhar_number='"+jTextField3.getText()+"' and phone_number='"+jTextField2.getText()+"'";
 ...
 if(evt.getKeyCode()==KeyEvent.VK_ENTER)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginPage_ForgotPassword_Customer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
